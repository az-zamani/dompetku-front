...
// state untuk toggle hide configurator
const isConfiguratorHidden = computed(() => store.state.isConfiguratorHidden);
const toggleHideConfigurator = () => {
  store.commit("toggleHideConfigurator");
};
</script>

<template>
  <div v-if="!isConfiguratorHidden" class="fixed-plugin">
    <a
    ...
    <div class="shadow-lg card">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div :class="isRTL ? 'float-end' : 'float-start'">
          <h5 class="mt-3 mb-0">Dompetku Theme</h5>
          <p>Customize your dashboard theme.</p>
        </div>
        <div
          class="mt-4"
          @click="toggleConfigurator"
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <!-- Hide Configurator Toggle -->
        <hr class="horizontal dark my-4" />
        <div class="mt-2 mb-5 d-flex">
          <h6 class="mb-0">Hide Configurator</h6>
          <div class="form-check form-switch ps-0 ms-auto my-auto">
            <input
              class="form-check-input mt-1 ms-auto"
              type="checkbox"
              :checked="isConfiguratorHidden"
              @click="toggleHideConfigurator"
            />
          </div>
        </div>
      </div>
